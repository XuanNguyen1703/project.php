            ...
            <div id="trademark-box" class="row">
                <div class="col-sm-12">
                    <ul id="trademark-list">
                        ...
                        <li>
                            <a href="#"><img src="Public/assets/data/trademark-ups.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><img src="Public/assets/data/trademark-visa.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><img src="Public/assets/data/trademark-fe.jpg"  alt="ups"/></a>
                        </li>
                        <li>
                            <a href="#"><img Public/assets/data/trademark-wm.jpg"  alt="ups"/></a>
                        </li>
                    </ul> 
                </div>
            </div> <!-- /#trademark-box -->
